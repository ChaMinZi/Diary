...
public class ColorPaletteViewAdapter extends RecyclerView.Adapter<ColorPaletteViewAdapter.ViewHolder> {

    private ColorPalette.OnFastChooseColorListener onFastChooseColorListener;
    private ArrayList<ColorComp> mDataset;
...
//        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        int textColor = ColorPaletteUtils.isWhiteText(color) ? Color.WHITE : Color.BLACK;
    ...
    public void setDefaultColor(int color) {
        for (int i = 0; i < mDataset.size(); i++) {
            ColorComp colorPal = mDataset.get(i);
